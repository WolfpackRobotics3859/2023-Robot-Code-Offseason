...
public class Constants 
{
    ...
    public static class SwerveConstants 
    {
        ...
        { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(275);//183.3
        ...
        public static final class Mod1 
        {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(240);//151.6
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(230); //137.5
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3
        {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(30);//301.1
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
      }
}
